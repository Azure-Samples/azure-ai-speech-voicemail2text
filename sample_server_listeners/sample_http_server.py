...
def create_ssl_context():
    ...
    ssl_context.load_cert_chain(certfile='etc/certs/listener/v2tic_listener.crt', keyfile='etc/certs/listener/v2tic_listener.key')
...
def run_http():
    ...
    print(f"HTTPS Server listening for responses on https://{host}:{port}/response")
    httpd.serve_forever()
