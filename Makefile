...
.PHONY: default_make build_image check_minikube_status start_minikube load_image deploy_pod start_dashboard get_status destroy_pod enable_autoscale destroy_autoscale ssh_pod clean quick_start
...
deploy_pod:
	...
	echo "Please execute command python sample_clients/sample_https_client.py" ;\
