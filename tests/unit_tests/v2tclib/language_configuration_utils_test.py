...
class TestLanguageConfigurationUtils(unittest.TestCase):
    ...
    def test_get_threshold_from_language_configuration_or_default(self):
        ...
        def default_func():
            return {'min_confidence_percentage': 70, 'max_audio_length_secs': 30}
        self.assertEqual(get_threshold_from_language_configuration_or_default(self.request, default_func, 'en-US', 'fr-FR'), {'min_confidence_percentage': 50, 'max_audio_length_secs': 10})
        self.assertEqual(get_threshold_from_language_configuration_or_default(self.request, default_func, 'invalid-language', 'fr-FR'), {'min_confidence_percentage': 60, 'max_audio_length_secs': 20})
        self.assertEqual(get_threshold_from_language_configuration_or_default(self.request, default_func, 'invalid-language-1', 'invalid-language-2'), {'min_confidence_percentage': 70, 'max_audio_length_secs': 30})
