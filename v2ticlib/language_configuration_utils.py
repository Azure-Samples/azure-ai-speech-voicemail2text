...
def resolve_single_language(request:dict, language_list:list):
    lid_enabled = False
    default_threshold = metadata_utils.get_default_thresholds()
...
def resolve_lid_languages(request:dict, language_list:list):
    lid_enabled = True
    default_lid_threshold = metadata_utils.get_default_lid_thresholds()
...
def get_lid_languages(request) -> str:
    default_lid_languages = metadata_utils.get_default_lid_languages()
