...
class RestClient:
    ...
    def post(self, service_endpoint, headers, body):
        ...
        response = requests.post(url=complete_url, headers=headers, data=body, cert=('certs/client/certificate.pem', 'certs/client/private_key.pem'), verify='../etc/certs/certificate.pem')
    ...
    def get(self,service_endpoint,headers):
        ...
        response = requests.get(url=complete_url, headers=headers, cert=('certs/client/certificate.pem', 'certs/client/private_key.pem'), verify='certs/v2tic_listener.crt')
